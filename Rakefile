...
desc 'Generate documentation for the quick_polls extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'QuickPollsExtension'
...
desc 'Test the quick_polls extension.'
...
namespace :test do
  desc 'Functional test the quick_polls extension.'
  ...
  desc 'Unit test the quick_polls extension.'
